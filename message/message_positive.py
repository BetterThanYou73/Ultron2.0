...
#Message content
a = em()
a['subject'] = '@Ultron2.0 Operation Successful'
a['from'] = from_addr
a['to'] = ','.join(to_addr)
a.set_content('''Greetings Sir/Ma'am,\nI would like to inform you that your requested task has been completed.\nFarewell\nUltron2.0''') #If the html text does not show
a.add_alternative("""\
<!DOCTYPE html>
<html>
    <body>
        ...
        <p>I would like to inform you that your requested task has been completed.</p></font>
        <font = 'Franklin Gothic', font size = 4, color = '464340'>
        <p>Farewell</p></font>
